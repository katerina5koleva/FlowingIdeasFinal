namespace FlowingIdeasApp
{
	partial class AddIdea
	{
		...
		private void InitializeComponent()
		{
			...
			radioButton1.Location = new Point(425, 39);
			...
			radioButton2.Location = new Point(425, 69);
			...
			radioButton3.Location = new Point(423, 99);
			...
			label2.Location = new Point(425, 136);
			label2.Name = "label2";
			...
			// txtIdea
			// 
			txtIdea.Location = new Point(423, 166);
			txtIdea.Multiline = true;
			txtIdea.Name = "txtIdea";
			txtIdea.Size = new Size(402, 171);
			txtIdea.TabIndex = 11;
			// 
			// errorProvider1
			// 
			...
			button1.Location = new Point(425, 354);
			...
			button2.Location = new Point(728, 354);
			...
			pictureBox2.Size = new Size(423, 440);
			...
			pictureBox1.Size = new Size(140, 151);

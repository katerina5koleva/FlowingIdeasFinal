...
namespace FlowingIdeas.Presentation
{
	partial class IdeasDataViewer
	{
		...
		private void InitializeComponent()
		{
			...
			dataGridView1.Location = new Point(367, 128);
			dataGridView1.Name = "dataGridView1";
			dataGridView1.RowHeadersWidth = 51;
			dataGridView1.RowTemplate.Height = 29;
			dataGridView1.Size = new Size(605, 284);
			...
			PhlosophicalCheckBox.Location = new Point(367, 23);
			...
			artisticIdeaCheckBox.Location = new Point(367, 61);
			...
			workIdeaCheckBox.Location = new Point(367, 98);
			...
			button2.Location = new Point(865, 53);
